...
import { ArrowRight } from 'lucide-react';
  ...
  const projects = [
    ...
    badges: [
      { label: 'Training & Development', color: 'bg-blue-700' },
  ...
  },
  {
    ...
    badges: [
      { label: 'Government Services', color: 'bg-blue-700' },
  ...
  },
  {
    ...
    badges: [
      { label: 'Survey & Research', color: 'bg-blue-700' },
      { label: 'Data Collection', color: 'bg-yellow-500 text-white' },
    ],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-8 overflow-x-auto pb-4 snap-x snap-mandatory px-4 md:px-8 lg:px-16 xl:px-32 2xl:justify-center">
          {projects.map((project, idx) => (
            <div
              key={project.title}
              className="bg-white rounded-2xl shadow-lg flex-shrink-0 w-[370px] max-w-full snap-center flex flex-col overflow-hidden border border-gray-100"
            >
              ...
              <div className="relative w-full h-48">
                ...
                <div className="absolute bottom-3 left-3 flex flex-wrap gap-2 z-10">
                  {project.badges.map((badge, i) => (
                    <span
                      key={badge.label}
                      className={`text-xs font-semibold px-3 py-1 rounded-full shadow ${badge.color} text-white`}
                    >
                      {badge.label}
                    </span>
                  ))}
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <ul className="text-blue-800 text-sm mb-2 pl-4 list-disc">
